            ...
            <div class="row g-0">
                ...
                <div class="col-md-9">
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="input-group p-0 shadow shadow-sm">
                                <span class="input-group-text" id="inputGroup">數量</span>
                                <input type="number" min="0" name="qty" id="qty" value="1" size="3" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup">
                                <button name="button01" id="button01" type="button" class="btn btn-outline-dark">加入購物車</button>
                            </div>
                        </div>
                    </div>
                </div>
