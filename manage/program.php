                                    ...
                                    <table class="table table-responsive table-striped m-t-30">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <button type="button"  onclick="deleteConfirm('program.php','<?=$row['sid']?>')" class="btn btn btn-default btn btn-flat btn-addon btn-sm m-b-5 m-l-5"><i class="ti-trash"></i>刪除</button></td>
                                            </tr>
                                            <?php
                                              $j++; }
                                              ?>
