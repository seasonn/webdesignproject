...
if (isset($_GET['Search'])) {
    ...
    if ($varSearch !=""){
        $varWhere= " where aid ='$varSearch' or aname like '%$varSearch%'";
    }
}
                                    ...
                                    <table class="table table-responsive table-striped m-t-30">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td><a href="admindetailu.php?id=<?=$row['aid']?>" ><button type="button" class="btn btn btn-info btn btn-flat btn-addon btn-sm m-b-5 m-l-5"><i class="ti-pencil-alt"></i>修改</button></a>
                                               <button type="button"  onclick="deleteConfirm('admin.php','<?=$row['aid']?>')" class="btn btn btn-default btn btn-flat btn-addon btn-sm m-b-5 m-l-5"><i class="ti-trash"></i>刪除</button></td>
                                            </tr>
                                            <?php
                                              $j++; }
                                              ?>
                                            ...
                                            <tr>
                                                <td colspan=4>
                                                    <?php if($page>1){?>
                                                        <a href="admin.php?page=<?=($page-1)?>&Search=<?=$varSearch?>" style="color:#000">上一頁|</a>
                                                    <?php }?>      
                                                    <?php
                                                        for ($i=1;$i<=$total_pages;$i++){
                                                            if ($page!=$i){?>
                                                                 <a href="admin.php?page=<?=$i?>&Search=<?=$varSearch?>" style="color:#000"><?=$i?></a>    
                                                    <?php
                                                            }
                                                            else
                                                                echo $i;
                                                    ...
                                                    <?php if($page < $total_pages){?>
                                                        <a href="admin.php?page=<?=($page+1)?>&Search=<?=$varSearch?>" style="color:#000">|下一頁</a>
                                                    <?php }?>                                       
                                               </td>
                                            </tr>
                                        </tbody>
