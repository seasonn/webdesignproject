                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="admindetailu.php?id=<?= $row['aid'] ?>"><button type="button" class="btn btn btn-info btn btn-flat btn-addon btn-sm m-b-5 m-l-5"><i class="ti-pencil-alt"></i>修改</button></a>
                                <button type="button" onclick="deleteConfirm('admin.php','<?= $row['aid'] ?>')" class="btn btn btn-default btn btn-flat btn-addon btn-sm m-b-5 m-l-5"><i class="ti-trash"></i>刪除</button>
                            </td>
                        </tr>
                    <?php
                        $j++;
